<?php
$pageTitle = "Sklep wkrótce";
$pageDesc = "Sklep internetowy Mario Bramy wkrótce dostępny. Nowoczesne bramy i ogrodzenia aluminiowe.";
include 'includes/header.php';
?>
    <main class="flex-grow flex items-center justify-center">
      <section class="py-20 lg:py-32 text-center">
